...
pub const RENDEZVOUS_SERVERS: &[&str] = &["10.10.100.170"];
pub const RS_PUB_KEY: &str = "ORH7lEUUDKVq999Z7p7JoX0QlLdXdowpvPLVn+DBkmQ=";

pub const RENDEZVOUS_PORT: i32 = 21916;
pub const RELAY_PORT: i32 = 21917;
